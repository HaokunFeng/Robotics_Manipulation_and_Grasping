...
from moveit_msgs.msg import MoveItErrorCodes, MoveGroupAction, OrientationConstraint, Constraints
...
class Arm(object):
    ...
    def move_to_pose(self,
        ...
        if result and result.error_code:
            error_description = self.moveit_error_string(result.error_code.val)
